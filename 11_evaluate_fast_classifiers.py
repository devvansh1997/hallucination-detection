"""
11_evaluate_fast_classifiers.py — RF vs LR vs MLP on Scaled 5k Subset
=======================================================================
Cached HOSVD factor matrices + StandardScaler + 5k stratified subset.
Tests axis-aligned (RF), linear (LR), and non-linear (MLP) boundaries.
"""
...
def evaluate_one(model_folder: str, dataset: str, idx: int = 1, total: int = 1):
    ...
    # MLP (HARP-style: single hidden layer, no weight decay)
    print(f"       Training MLP (128) ...", flush=True, end="")
