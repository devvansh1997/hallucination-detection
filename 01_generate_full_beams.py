"""
01_generate_full_beams.py — Full 10-Beam Generation (NO early stop)
=====================================================================
Processes ALL 10 beams per prompt regardless of correctness.
Matches HARP's protocol: known prompts contribute all beams
(including hallucinated ones after the first correct answer).
...
def main():
    ...
    for model_cfg in models_to_run:
        ...
        for ds_cfg in datasets_to_run:
            ...
            out_path = os.path.join(out_dir, f"{ds_name}_pooled_fullbeams.pt")
